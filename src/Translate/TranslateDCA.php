...
class TranslateDCA
{
    ...
    public function translateModel(Model $model, $fromLang, $toLang): void
    {
    ...
    public function translateLinkUrl(?string $value, string $toLang): ?string
    {
        if (!$value) {
            return $value;
        }
    ...
    public function getTranslatePage(?int $value, string $toLang): ?int
    {
        if (!$value) {
            return $value;
        }
    ...
    public function translateLinkUrlOfRteField(Model $model, $field, $toLang): ?string
    {
        $value = $model->$field;
        if (empty($value)) {
            return $value;
